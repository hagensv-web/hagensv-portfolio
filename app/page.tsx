    ...
    <div className="flex flex-col gap-y-10">
      <ImageLeftContentRight 
        ...
        imageCredit={
          ...
          <p>I am a programming enthusiast. I love to create, push my skills, and learn new things. I love almost all things programming, except for databases. If you would like to see what I am currently working on, check out my <StyledLink href={"/projects"}>projects</StyledLink>.</p>
      </ImageLeftContentRight>

      <ImageRightContentLeft imageSrc="/application-768x513.jpg">
          ...
          <p>I would love to hear from you. If you would like to get in contact feel free to send me an email.</p>
